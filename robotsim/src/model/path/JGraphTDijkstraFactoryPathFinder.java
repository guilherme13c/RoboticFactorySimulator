...
public class JGraphTDijkstraFactoryPathFinder
		extends AbstractFactoryPathFinder<DefaultDirectedGraph<PositionedShape, DefaultEdge>, PositionedShape>
	...
	public List<Position> findPath(final Component sourceComponent, final Component targetComponent) {
		...
		final GraphPath<PositionedShape, DefaultEdge> shortestPath = DijkstraShortestPath.findPathBetween(graph,
