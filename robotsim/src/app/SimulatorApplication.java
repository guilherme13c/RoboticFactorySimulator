	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
	        ...
	        public void run() {
				...
				final FactoryPersistenceManagerClient persistenceClient = new FactoryPersistenceManagerClient(factoryPersistenceManagerServerAddress[0], Integer.parseInt(factoryPersistenceManagerServerAddress[1]), canvasChooser);
